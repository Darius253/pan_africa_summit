...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xff06004C),
      surfaceTint: Color(0xff06004C),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff896177),
      ...
      tertiaryFixed: Color(0xff896177),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff2d2c63),
      onPrimaryFixedVariant: Color(0xffffffff),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      inversePrimary: Color(0xff06004C),
      primaryFixed: Color(0xffe2dfff),
      onPrimaryFixed: Color(0xff15134a),
      primaryFixedDim: Color(0xffc2c1ff),
      onPrimaryFixedVariant: Color(0xff414178),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xffbebdfd),
      onPrimaryContainer: Color(0xff04003b),
